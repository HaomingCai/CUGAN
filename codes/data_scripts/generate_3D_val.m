...
input_path = '/Users/hm_cai/PycharmProjects/CResMD-master/datasets/DIV2K_Valid_LR/LR/x2';
save_LR_root = '/Users/hm_cai/PycharmProjects/CResMD-master/datasets/datasets/DIV2K_Valid_3Group_x2';
...
%                             imwrite(im_noise, fullfile(save_LR_path, [imname '_' num2str(kernel_label, '%02d') num2str(noise_label, '%02d') num2str(jpeg_label, '%02d') '.jpg']), 'jpg', 'Quality', JPEG_Quality);
                            imwrite(im_noise, fullfile(save_LR_path, [imname '.jpg']), 'jpg', 'Quality', JPEG_Quality);
                        else
